...
export const getImage = (http, { id, returns, size, backgroundSize, choiceSize }) => {
  let requestQuery = {
    method: 'get',
    url: `/images/${id}`
  }
  ...
  const choiceImageSizes = ['default', 'thumbnail', 'supersize', 'supermobile', 'supersizefit', 'supermobilefit']
