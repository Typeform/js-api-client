...
export class TypeformImages {
   ...
   * 
   * @param args.image Base64 code for the image. Note that base64 encoders may add descriptors to the code (such as data:image/png;base64,). Do not include these descriptors in your image string---include only the base64 code.
   ...
   * 
   * @param args.id Unique ID for the image to retrieve.
   * @param args.returns Default is to return the binary of the original image. Use 'json' to specify application/json to return the JSON description of the image instead.
   ...
   * @param args.choiceSize Image size to retrieve. Options include "default", "thumbnail", "supersize", "supermobile", "supersizefit", "supermobilefit"
