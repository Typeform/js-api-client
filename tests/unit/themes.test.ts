...
import { TypeformThemes } from '../../src/themes';
import { ITypeform } from '../../src/interface';

declare const fetch: any;

const mockThemePayload: ITypeform.Themes.Create = {
  name: 'New theme',
  colors: {
    answer: '#4FB0AE',
    background: '#FFFFF',
...
const themesRequest = new TypeformThemes(http);
